...
var _user$project$Types$AuthResponse = F2(
	function (a, b) {
		return {code: a, token: b};
	});
var _user$project$Types$User = F3(
	function (a, b, c) {
		return {username: a, password: b, token: c};
	});
var _user$project$Types$PostMetaInfo = F9(
...
var _user$project$Messages$SetLatLong = F2(
	function (a, b) {
		return {ctor: 'SetLatLong', _0: a, _1: b};
	});
var _user$project$Messages$SetLongitude = function (a) {
	return {ctor: 'SetLongitude', _0: a};
};
var _user$project$Messages$SetLatitude = function (a) {
	return {ctor: 'SetLatitude', _0: a};
};
var _user$project$Messages$DeliverMessage = {ctor: 'DeliverMessage'};
var _user$project$Messages$MessageInput = function (a) {
	return {ctor: 'MessageInput', _0: a};
};
var _user$project$Messages$StartChat = {ctor: 'StartChat'};
...
var _user$project$Messages$OnPostListResponse = function (a) {
	return {ctor: 'OnPostListResponse', _0: a};
};
var _user$project$Messages$OnAuthCmdResponse = function (a) {
	return {ctor: 'OnAuthCmdResponse', _0: a};
};
var _user$project$Messages$AuthRequest = {ctor: 'AuthRequest'};
var _user$project$Messages$OnLocationChange = function (a) {
	return {ctor: 'OnLocationChange', _0: a};
};
var _user$project$Messages$NewUrl = function (a) {
	return {ctor: 'NewUrl', _0: a};
};
var _user$project$Messages$SelectMenuTab = function (a) {
	return {ctor: 'SelectMenuTab', _0: a};
};

var _user$project$Helpers$tokenHeader = function (token) {
	var _p0 = token;
	if (_p0.ctor === 'Just') {
		return A2(_elm_lang$http$Http$header, 'Authorization', _p0._0);
	} else {
		return A2(_elm_lang$http$Http$header, 'Authorization', 'No token');
	}
};
var _user$project$Helpers$cmd = function (msg) {
	return A2(
		_elm_lang$core$Task$perform,
...
var _user$project$Commands$postMetaInfoDecoder = A3(
						...
						A3(
							...
							A3(
								...
								A3(
									...
									'slug',
									_elm_lang$core$Json_Decode$string,
									_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Types$PostMetaInfo))))))))));
var _user$project$Commands$postlistDecoder = _elm_lang$core$Json_Decode$list(_user$project$Commands$postMetaInfoDecoder);
var _user$project$Commands$postlistExpect = _elm_lang$http$Http$expectJson(_user$project$Commands$postlistDecoder);
var _user$project$Commands$collectionDecoder = A3(
	...
	A3(
		...
		'code',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Types$AuthResponse)));
var _user$project$Commands$authResponseExpect = _elm_lang$http$Http$expectJson(_user$project$Commands$collectionDecoder);
var _user$project$Commands$authBody = F2(
...
var _user$project$Commands$getPostListUrl = function (api_url) {
	return A2(_elm_lang$core$Basics_ops['++'], api_url, '/posts');
};
var _user$project$Commands$getPostList = F2(
	function (token, api_url) {
		return A2(
			_elm_lang$http$Http$send,
			_user$project$Messages$OnPostListResponse,
			_elm_lang$http$Http$request(
				{
					...
					url: _user$project$Commands$getPostListUrl(api_url),
					body: _elm_lang$http$Http$emptyBody,
					expect: _user$project$Commands$postlistExpect,
					timeout: _elm_lang$core$Maybe$Nothing,
					withCredentials: false
				}));
	});
var _user$project$Commands$authRequestUrl = function (api_url) {
	return A2(_elm_lang$core$Basics_ops['++'], api_url, '/auth');
};
var _user$project$Commands$authRequest = F4(
	function (token, api_url, username, password) {
		return A2(
			_elm_lang$http$Http$send,
			_user$project$Messages$OnAuthCmdResponse,
			_elm_lang$http$Http$request(
				{
					method: 'POST',
					headers: {
					...
					url: _user$project$Commands$authRequestUrl(api_url),
					body: A2(_user$project$Commands$authBody, username, password),
					expect: _user$project$Commands$authResponseExpect,
					timeout: _elm_lang$core$Maybe$Nothing,
					withCredentials: false
				}));
	});

var _user$project$Routing$urlFor = F2(
	function (src_url, route) {
		var _p0 = route;
		switch (_p0.ctor) {
			case 'HomeRoute':
				return src_url;
			case 'LoginRoute':
				return A2(_elm_lang$core$Basics_ops['++'], src_url, '/login');
			case 'LogoutRoute':
				return A2(_elm_lang$core$Basics_ops['++'], src_url, '/logout');
			case 'RegisterRoute':
				return A2(_elm_lang$core$Basics_ops['++'], src_url, '/register');
			case 'PostListRoute':
				return A2(_elm_lang$core$Basics_ops['++'], src_url, '/postlist');
			...
			case 'ProjectListRoute':
				return A2(_elm_lang$core$Basics_ops['++'], src_url, '/projectlist');
...
var _user$project$Routing$parseAppend = F2(
	function (src_url, item) {
		var _p1 = src_url;
		if (_p1 === '') {
			return item;
		} else {
				...
				_elm_lang$core$List$reverse(
					A2(
						...
						A2(
							_elm_lang$core$String$split,
							'/',
							A2(_elm_lang$core$String$dropLeft, 1, src_url)))));
		}
	});
...
var _user$project$Routing$ProjectListRoute = {ctor: 'ProjectListRoute'};
var _user$project$Routing$PostDetailRoute = function (a) {
	return {ctor: 'PostDetailRoute', _0: a};
};
var _user$project$Routing$PostListRoute = {ctor: 'PostListRoute'};
var _user$project$Routing$RegisterRoute = {ctor: 'RegisterRoute'};
var _user$project$Routing$LogoutRoute = {ctor: 'LogoutRoute'};
var _user$project$Routing$LoginRoute = {ctor: 'LoginRoute'};
var _user$project$Routing$routingItem = function (src_url) {
	return {
		ctor: '::',
		_0: {
			ctor: '_Tuple4',
			_0: 'Post',
			_1: 'fa fa-apps',
			_2: _user$project$Routing$PostListRoute,
			_3: A2(_elm_lang$core$Basics_ops['++'], src_url, '/postlist')
		},
		_1: {
			ctor: '::',
			_0: {
				...
				_0: 'Project',
				_1: 'fa fa-list',
				_2: _user$project$Routing$ProjectListRoute,
				_3: A2(_elm_lang$core$Basics_ops['++'], src_url, '/projectlist')
			},
			_1: {
				ctor: '::',
				_0: {
					...
					_0: 'Login',
					_1: 'fa fa-male',
					_2: _user$project$Routing$LoginRoute,
...
var _user$project$Routing$tabsTitles = function (src_url) {
	return A2(
		_elm_lang$core$List$map,
		function (_p2) {
			var _p3 = _p2;
		...
		_user$project$Routing$routingItem(src_url));
};
var _user$project$Routing$tabsUrls = function (src_url) {
...
var _user$project$Routing$urlTabs = function (src_url) {
	return _elm_lang$core$Dict$fromList(
		A2(
			...
			F2(
				function (idx, _p6) {
					var _p7 = _p6;
					return {ctor: '_Tuple2', _0: _p7._3, _1: idx};
				}),
			_user$project$Routing$routingItem(src_url)));
};
var _user$project$Routing$routingItemHomePage = function (src_url) {
	return {
		ctor: '::',
		_0: {
			ctor: '_Tuple4',
...
var _user$project$Routing$routingItemNormalHeader = function (src_url) {
	return {
		ctor: '::',
		_0: {
			ctor: '_Tuple4',
...
var _user$project$Routing$matchers = function (src_url) {
	return _evancz$url_parser$UrlParser$oneOf(
		{
			...
			_0: A2(
				...
				A2(_user$project$Routing$parseAppend, src_url, _evancz$url_parser$UrlParser$top)),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					...
					A2(
						_user$project$Routing$parseAppend,
						src_url,
				...
				_1: {
					...
					_0: A2(
						_evancz$url_parser$UrlParser$map,
						_user$project$Routing$LogoutRoute,
						A2(
							_user$project$Routing$parseAppend,
							src_url,
					...
					_1: {
						...
						_1: {
							...
							_0: A2(
								_evancz$url_parser$UrlParser$map,
								_user$project$Routing$PostListRoute,
								A2(
									_user$project$Routing$parseAppend,
									src_url,
							...
							_1: {
								...
								_0: A2(
									_evancz$url_parser$UrlParser$map,
									_user$project$Routing$PostDetailRoute,
									A2(
										_evancz$url_parser$UrlParser_ops['</>'],
										A2(
											_user$project$Routing$parseAppend,
											src_url,
											_evancz$url_parser$UrlParser$s('postdetail')),
										_evancz$url_parser$UrlParser$string)),
								_1: {
									ctor: '::',
									_0: A2(
										_evancz$url_parser$UrlParser$map,
										_user$project$Routing$ProjectListRoute,
										A2(
											_user$project$Routing$parseAppend,
											src_url,
											_evancz$url_parser$UrlParser$s('projectlist'))),
									_1: {
										ctor: '::',
										_0: A2(
											_evancz$url_parser$UrlParser$map,
											_user$project$Routing$ProjectDetailRoute,
											A2(
												_evancz$url_parser$UrlParser_ops['</>'],
												A2(
													_user$project$Routing$parseAppend,
													src_url,
													_evancz$url_parser$UrlParser$s('projectdetail')),
												_evancz$url_parser$UrlParser$string)),
										_1: {ctor: '[]'}
									}
								}
...
var _user$project$Routing$parseLocation = F2(
	function (location, src_url) {
		var _p8 = A2(
			_evancz$url_parser$UrlParser$parsePath,
			_user$project$Routing$matchers(src_url),
			location);
		if (_p8.ctor === 'Just') {
			return _p8._0;
		} else {
...
var _user$project$Routing$routingItemPost = function (src_url) {
	return {
		ctor: '::',
		_0: {
			ctor: '_Tuple4',
...
var _user$project$Models$Ui = F2(
	function (a, b) {
		return {selectedMenuTab: a, sideMenuActive: b};
	});
var _user$project$Models$initialModel = F3(
	function (route, url, selectedMenuTab) {
		return {
			ui: A2(_user$project$Models$Ui, selectedMenuTab, false),
			route: route,
			url: url,
...
var _user$project$Models$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {ui: a, route: b, url: c, user: d, newMessage: e, latitude: f, longitude: g, postList: h};
	});
...
var _user$project$Views_Map$onChange = function (toMsg) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'change',
		A2(
			...
			A2(
				...
				A2(_elm_lang$core$Json_Decode$andThen, _user$project$Views_Map$decodeLatLong, _elm_lang$core$Json_Decode$string))));
};
var _user$project$Views_Map$recordLatLongOnDrag = A2(
	_elm_lang$html$Html_Events$on,
	'google-map-drag',
	A3(
		_elm_lang$core$Json_Decode$map2,
		_user$project$Messages$SetLatLong,
		A2(
			_elm_lang$core$Json_Decode$at,
			{
				ctor: '::',
		...
		A2(
			...
			_elm_lang$core$Json_Decode$float)));
var _user$project$Views_Map$googleMap = _elm_lang$html$Html$node('google-map');
var _user$project$Views_Map$mapView = function (model) {
	return A2(
								...
								_1: {
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _user$project$Views_Map$onChange(_user$project$Messages$SetLatitude),
												_1: {ctor: '[]'}
											}
										}
									}
			...
			_1: {
									...
									_1: {
										...
										_1: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _user$project$Views_Map$onChange(_user$project$Messages$SetLongitude),
													_1: {ctor: '[]'}
												}
											}
										}
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: A2(
							_user$project$Views_Map$googleMap,
							{
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html_Attributes$attribute,
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _user$project$Views_Map$recordLatLongOnDrag,
											_1: {ctor: '[]'}
										}
									}
								}
...
var _user$project$Styles_Matrix$buttonRadius = _rtfeldman$elm_css$Css$px(4);
var _user$project$Styles_Matrix$searchBarHeight = _rtfeldman$elm_css$Css$px(30);
var _user$project$Styles_Matrix$sectionMargin = _rtfeldman$elm_css$Css$px(25);
var _user$project$Styles_Matrix$doubleBaseMargin = _rtfeldman$elm_css$Css$px(20);
var _user$project$Styles_Matrix$baseMargin = _rtfeldman$elm_css$Css$px(10);
var _user$project$Styles_Matrix$menuWidth = _rtfeldman$elm_css$Css$px(150);
var _user$project$Styles_Matrix$navBarHeight = _rtfeldman$elm_css$Css$px(64);

var _user$project$Styles_Colors$white = _rtfeldman$elm_css$Css$hex('#FFFFFF');
var _user$project$Styles_Colors$snow = _user$project$Styles_Colors$white;
var _user$project$Styles_Colors$drawer = A4(_rtfeldman$elm_css$Css$rgba, 30, 30, 29, 0.95);
var _user$project$Styles_Colors$fire = _rtfeldman$elm_css$Css$hex('#e73536');
var _user$project$Styles_Colors$ember = A4(_rtfeldman$elm_css$Css$rgba, 164, 0, 48, 0.5);
var _user$project$Styles_Colors$bloodOrange = _rtfeldman$elm_css$Css$hex('#fb5f26');
var _user$project$Styles_Colors$coal = _rtfeldman$elm_css$Css$hex('#2d2d2d');
var _user$project$Styles_Colors$charcoal = _rtfeldman$elm_css$Css$hex('#595959');
var _user$project$Styles_Colors$panther = _rtfeldman$elm_css$Css$hex('#161616');
var _user$project$Styles_Colors$windowTint = A4(_rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0.4);
var _user$project$Styles_Colors$cloud = A4(_rtfeldman$elm_css$Css$rgba, 200, 200, 200, 0.35);
var _user$project$Styles_Colors$frost = _rtfeldman$elm_css$Css$hex('#D8D8D8');
var _user$project$Styles_Colors$ricePaper = A4(_rtfeldman$elm_css$Css$rgba, 255, 255, 255, 0.75);
var _user$project$Styles_Colors$transparent = A4(_rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0);
var _user$project$Styles_Colors$error = A4(_rtfeldman$elm_css$Css$rgba, 200, 0, 0, 0.8);
var _user$project$Styles_Colors$steel = _rtfeldman$elm_css$Css$hex('#CCCCCC');
var _user$project$Styles_Colors$facebook = _rtfeldman$elm_css$Css$hex('#3b5998');
var _user$project$Styles_Colors$clear = A4(_rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0);
var _user$project$Styles_Colors$ribbonBackground = _rtfeldman$elm_css$Css$hex('#1F0808');
var _user$project$Styles_Colors$background = _rtfeldman$elm_css$Css$hex('#1F0808');

var _user$project$Styles_LayoutStyle$layoutNamespace = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('meilab');
var _user$project$Styles_LayoutStyle$MenuInActive = {ctor: 'MenuInActive'};
var _user$project$Styles_LayoutStyle$MenuActive = {ctor: 'MenuActive'};
var _user$project$Styles_LayoutStyle$MenuLink = {ctor: 'MenuLink'};
var _user$project$Styles_LayoutStyle$MenuList = {ctor: 'MenuList'};
var _user$project$Styles_LayoutStyle$MenuItem = {ctor: 'MenuItem'};
var _user$project$Styles_LayoutStyle$LayoutHeader = {ctor: 'LayoutHeader'};
var _user$project$Styles_LayoutStyle$MenuSelected = {ctor: 'MenuSelected'};
var _user$project$Styles_LayoutStyle$FixedNavBarContainer = {ctor: 'FixedNavBarContainer'};
var _user$project$Styles_LayoutStyle$NavBarWrapper = {ctor: 'NavBarWrapper'};
var _user$project$Styles_LayoutStyle$MenuContainer = {ctor: 'MenuContainer'};
var _user$project$Styles_LayoutStyle$SideBarMenu = {ctor: 'SideBarMenu'};
var _user$project$Styles_LayoutStyle$Layout = {ctor: 'Layout'};
var _user$project$Styles_LayoutStyle$css = function (_p0) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, _user$project$Styles_LayoutStyle$layoutNamespace.name, _p0));
}(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css_Elements$body(
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$backgroundColor(_user$project$Styles_Colors$background),
						_1: {ctor: '[]'}
					}
				}
			}),
		_1: {
			...
			_0: A2(
				...
				_user$project$Styles_LayoutStyle$Layout,
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					_rtfeldman$elm_css$Css$class,
					_user$project$Styles_LayoutStyle$MenuContainer,
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$displayFlex,
						_1: {
				...
				_1: {
					...
					_0: A2(
						_rtfeldman$elm_css$Css$class,
						_user$project$Styles_LayoutStyle$NavBarWrapper,
						{
							ctor: '::',
							_0: A3(
								...
								_rtfeldman$elm_css$Css$int(0),
								_user$project$Styles_Matrix$navBarHeight),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							_rtfeldman$elm_css$Css$class,
							_user$project$Styles_LayoutStyle$FixedNavBarContainer,
							{
								ctor: '::',
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _rtfeldman$elm_css$Css$backgroundColor(_rtfeldman$elm_css$Css_Colors$teal),
										_1: {
											ctor: '::',
											_0: _rtfeldman$elm_css$Css$displayFlex,
											_1: {
												ctor: '::',
												_0: _rtfeldman$elm_css$Css$justifyContent(_rtfeldman$elm_css$Css$stretch),
												_1: {
													ctor: '::',
													_0: _rtfeldman$elm_css$Css$alignItems(_rtfeldman$elm_css$Css$center),
													_1: {
						...
						_1: {
							...
							_0: A2(
								_rtfeldman$elm_css$Css$class,
								_user$project$Styles_LayoutStyle$MenuList,
								{
									ctor: '::',
...
var _user$project$ViewHelpers$externalLinkItem = F4(
	function (slug, linkClass, iconClass, textToShow) {
		return A2(
...
var _user$project$ViewHelpers$_p0 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('meilab');
var _user$project$ViewHelpers$id = _user$project$ViewHelpers$_p0.id;
var _user$project$ViewHelpers$class = _user$project$ViewHelpers$_p0.$class;
var _user$project$ViewHelpers$classList = _user$project$ViewHelpers$_p0.classList;
var _user$project$ViewHelpers$linkItem = F6(
		...
		return A2(
			_elm_lang$html$Html$li,
			{
				...
				_0: _user$project$ViewHelpers$class(
					{
						ctor: '::',
						_0: _user$project$Styles_LayoutStyle$MenuItem,
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
			...
			},
			{
				...
				_0: A2(
					_elm_lang$html$Html$a,
					{
						...
						_1: {
							ctor: '::',
							_0: _user$project$ViewHelpers$navigationOnClick(onClickCmd),
							_1: {
								ctor: '::',
								_0: aClass,
								_1: {ctor: '[]'}
...
var _user$project$ViewHelpers$predefinedLinkItem = F4(
	function (aClass, iconClass, slug, textToShow) {
		return A6(
			_user$project$ViewHelpers$linkItem,
			_user$project$ViewHelpers$class(
				{ctor: '[]'}),
			_user$project$Messages$NoOp,
			aClass,
			iconClass,
			slug,
			textToShow);
	});
var _user$project$ViewHelpers$menuHeadingLinkItem = F3(
	function (iconClass, slug, textToShow) {
		return A6(
			_user$project$ViewHelpers$linkItem,
			_user$project$ViewHelpers$class(
				{ctor: '[]'}),
...
var _user$project$ViewHelpers$normalLinkItem = F2(
	function (slug, textToShow) {
		return A4(
			_user$project$ViewHelpers$predefinedLinkItem,
			_user$project$ViewHelpers$class(
				{ctor: '[]'}),
			'',
			slug,
...
var _user$project$ViewHelpers$navItem = F2(
	function (model, _p1) {
		var _p2 = _p1;
		var _p5 = _p2._2;
		...
		var _p3 = function () {
			...
			if ((_p4.ctor === '_Tuple2') && (_p4._0 === false)) {
				return {
					ctor: '_Tuple2',
					_0: _user$project$Messages$NewUrl(
						A2(_user$project$Routing$urlFor, model.url.src_url, _p4._1)),
					_1: _user$project$ViewHelpers$class(
						{ctor: '[]'})
				};
			} else {
				return {
					ctor: '_Tuple2',
					_0: _user$project$Messages$NoOp,
					_1: _user$project$ViewHelpers$class(
						{
							ctor: '::',
							_0: _user$project$Styles_LayoutStyle$MenuSelected,
							_1: {ctor: '[]'}
						})
				};
			}
...
var _user$project$ViewHelpers$navContainer = function (model) {
	return A2(
		_elm_lang$html$Html$nav,
		{
			...
			_0: _user$project$ViewHelpers$class(
				{
					ctor: '::',
					_0: _user$project$Styles_LayoutStyle$MenuContainer,
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
		{
			...
			_0: A2(
				...
				A2(
					...
					_user$project$Routing$routingItem(model.url.src_url))),
			_1: {ctor: '[]'}
		});
};
var _user$project$ViewHelpers$marketingFixedHeader = F3(
	function (model, siteTitle, routingItem) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _user$project$ViewHelpers$class(
					{
						ctor: '::',
						_0: _user$project$Styles_LayoutStyle$NavBarWrapper,
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
				...
				_0: A2(
					_elm_lang$html$Html$nav,
					{
						...
						_0: _user$project$ViewHelpers$class(
							{
								ctor: '::',
								_0: _user$project$Styles_LayoutStyle$FixedNavBarContainer,
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					},
						...
						_0: A2(
							_elm_lang$html$Html$ul,
							{
								...
								_0: _user$project$ViewHelpers$class(
									{
										ctor: '::',
										_0: _user$project$Styles_LayoutStyle$MenuList,
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A3(_user$project$ViewHelpers$menuHeadingLinkItem, '', '/', siteTitle),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
...
var _user$project$ViewHelpers$layoutHeader = F3(
	function (model, siteTitle, routingItem) {
		return A2(
			_elm_lang$html$Html$nav,
			{
				...
				_0: _user$project$ViewHelpers$class(
					{
						ctor: '::',
						_0: _user$project$Styles_LayoutStyle$LayoutHeader,
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
	...
	function (slug, iconClass, textToShow) {
		return A2(
			...
			},
			{
				ctor: '::',
				_0: A4(
					_user$project$ViewHelpers$externalLinkItem,
					slug,
					_user$project$ViewHelpers$class(
						{
							ctor: '::',
							_0: _user$project$Styles_LayoutStyle$MenuLink,
							_1: {ctor: '[]'}
						}),
					iconClass,
					textToShow),
...
var _user$project$Styles_MarketingStyle$marketingNamespace = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('meilab');
var _user$project$Styles_MarketingStyle$Button = {ctor: 'Button'};
var _user$project$Styles_MarketingStyle$SubContainer = {ctor: 'SubContainer'};
var _user$project$Styles_MarketingStyle$GroupContainer = {ctor: 'GroupContainer'};
var _user$project$Styles_MarketingStyle$Footer = {ctor: 'Footer'};
var _user$project$Styles_MarketingStyle$Ribbon = {ctor: 'Ribbon'};
var _user$project$Styles_MarketingStyle$ContentSubhead = {ctor: 'ContentSubhead'};
var _user$project$Styles_MarketingStyle$ContentHeadRibbon = {ctor: 'ContentHeadRibbon'};
var _user$project$Styles_MarketingStyle$ContentHead = {ctor: 'ContentHead'};
var _user$project$Styles_MarketingStyle$Content = {ctor: 'Content'};
var _user$project$Styles_MarketingStyle$ContentContainer = {ctor: 'ContentContainer'};
var _user$project$Styles_MarketingStyle$SplashSubhead = {ctor: 'SplashSubhead'};
var _user$project$Styles_MarketingStyle$SplashHead = {ctor: 'SplashHead'};
var _user$project$Styles_MarketingStyle$Splash = {ctor: 'Splash'};
var _user$project$Styles_MarketingStyle$SplashContainer = {ctor: 'SplashContainer'};
var _user$project$Styles_MarketingStyle$Layout = {ctor: 'Layout'};
var _user$project$Styles_MarketingStyle$css = function (_p0) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, _user$project$Styles_MarketingStyle$marketingNamespace.name, _p0));
}(
	{
		ctor: '::',
		_0: A2(
			_rtfeldman$elm_css$Css$class,
			_user$project$Styles_MarketingStyle$Layout,
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Css$displayFlex,
				_1: {
		...
		_1: {
			...
			_0: A2(
				_rtfeldman$elm_css$Css$class,
				_user$project$Styles_MarketingStyle$SplashContainer,
				{
					ctor: '::',
					_0: A3(
						_rtfeldman$elm_css$Css$flex3,
			...
			_1: {
				...
				_0: A2(
					_rtfeldman$elm_css$Css$class,
					_user$project$Styles_MarketingStyle$Splash,
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$displayFlex,
						_1: {
				...
				_1: {
					...
					_0: A2(
						_rtfeldman$elm_css$Css$class,
						_user$project$Styles_MarketingStyle$SplashHead,
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$color(_user$project$Styles_Colors$snow),
							_1: {
								ctor: '::',
					...
					_1: {
						...
						_0: A2(
							_rtfeldman$elm_css$Css$class,
							_user$project$Styles_MarketingStyle$SplashSubhead,
							{
								ctor: '::',
								_0: _rtfeldman$elm_css$Css$color(_user$project$Styles_Colors$snow),
								_1: {ctor: '[]'}
						...
						_1: {
							...
							_0: A2(
								_rtfeldman$elm_css$Css$class,
								_user$project$Styles_MarketingStyle$ContentContainer,
								{
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$flex(
										_rtfeldman$elm_css$Css$int(1)),
							...
							_1: {
								...
								_0: A2(
									_rtfeldman$elm_css$Css$class,
									_user$project$Styles_MarketingStyle$GroupContainer,
									{
										ctor: '::',
										_0: _rtfeldman$elm_css$Css$displayFlex,
										_1: {
								...
								_1: {
									...
									_0: A2(
										_rtfeldman$elm_css$Css$class,
										_user$project$Styles_MarketingStyle$SubContainer,
										{
											ctor: '::',
											...
											_1: {
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _rtfeldman$elm_css$Css$marginTop(_rtfeldman$elm_css$Css$auto),
														_1: {ctor: '[]'}
													}
												}
											}
									...
									_1: {
										...
										_0: A2(
											_rtfeldman$elm_css$Css$class,
											_user$project$Styles_MarketingStyle$ContentSubhead,
											{
												ctor: '::',
												_0: _rtfeldman$elm_css$Css$color(_user$project$Styles_Colors$facebook),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												_rtfeldman$elm_css$Css$class,
												_user$project$Styles_MarketingStyle$Footer,
												{
													ctor: '::',
													_0: _rtfeldman$elm_css$Css$backgroundColor(_user$project$Styles_Colors$background),
													_1: {
														ctor: '::',
														_0: _rtfeldman$elm_css$Css$height(_user$project$Styles_Matrix$navBarHeight),
														_1: {
															ctor: '::',
...
var _user$project$Views_Home$_p0 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('meilab');
var _user$project$Views_Home$id = _user$project$Views_Home$_p0.id;
var _user$project$Views_Home$class = _user$project$Views_Home$_p0.$class;
var _user$project$Views_Home$classList = _user$project$Views_Home$_p0.classList;
var _user$project$Views_Home$splash = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _user$project$Views_Home$class(
			{
				ctor: '::',
				_0: _user$project$Styles_MarketingStyle$SplashContainer,
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	},
		...
		_0: A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _user$project$Views_Home$class(
					{
						ctor: '::',
						_0: _user$project$Styles_MarketingStyle$Splash,
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
				...
				_0: A2(
					_elm_lang$html$Html$h1,
					{
						...
						_0: _user$project$Views_Home$class(
							{
								ctor: '::',
								_0: _user$project$Styles_MarketingStyle$SplashHead,
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					},
					...
					_0: A2(
						_elm_lang$html$Html$p,
						{
							...
							_0: _user$project$Views_Home$class(
								{
									ctor: '::',
									_0: _user$project$Styles_MarketingStyle$SplashSubhead,
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('前沿技术培训 项目咨询'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A4(
									_user$project$ViewHelpers$predefinedLinkItem,
									_user$project$Views_Home$class(
										{
											ctor: '::',
											_0: _user$project$Styles_MarketingStyle$Button,
											_1: {ctor: '[]'}
										}),
									'',
									'/projectlist',
...
var _user$project$Views_Home$services = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _user$project$Views_Home$class(
			{
				ctor: '::',
				_0: _user$project$Styles_MarketingStyle$Ribbon,
				_1: {
					ctor: '::',
					_0: _user$project$Styles_MarketingStyle$GroupContainer,
					_1: {ctor: '[]'}
				}
			}),
		_1: {ctor: '[]'}
		...
		_0: A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _user$project$Views_Home$class(
					{
						ctor: '::',
						_0: _user$project$Styles_MarketingStyle$SubContainer,
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
			{
				...
				_0: A2(
					_elm_lang$html$Html$img,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$alt('File Icons'),
							_1: {
								ctor: '::',
					...
					_0: A2(
						_elm_lang$html$Html$h2,
						{
							...
							_0: _user$project$Views_Home$class(
								{
									ctor: '::',
									_0: _user$project$Styles_MarketingStyle$ContentHead,
									_1: {
										ctor: '::',
										_0: _user$project$Styles_MarketingStyle$ContentHeadRibbon,
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('提供服务'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('项目开发 培训 咨询'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Views_Home$projectsDetail = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _user$project$Views_Home$class(
				...
				_0: A2(
					_elm_lang$html$Html$h3,
					{
						...
						_0: _user$project$Views_Home$class(
							{
								ctor: '::',
								_0: _user$project$Styles_MarketingStyle$ContentSubhead,
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('fa fa-mobile'),
								_1: {ctor: '[]'}
							},
							{ctor: '[]'}),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html$text('物联网平台'),
							_1: {ctor: '[]'}
						}
					}),
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('智能连接一切设备，实时追踪，控制'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('技术栈：Elixir, MQTT, Elm, C, React-Native'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('fa fa-rocket'),
									_1: {ctor: '[]'}
								},
								{ctor: '[]'}),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html$text('区块链平台'),
								_1: {ctor: '[]'}
							}
						}),
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('分布式账簿'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('技术栈：Elixir, Blockchain, Elm'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('fa fa-th-large'),
										_1: {ctor: '[]'}
									},
									{ctor: '[]'}),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text('会议系统，协作平台'),
									_1: {ctor: '[]'}
								}
							}),
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('多人视频会议，桌面共享'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('技术栈：Elixir, WebRTC, Elm, Socket'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
						...
						},
						{
							...
							_0: A2(
								...
								},
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text('聊天机器人'),
										_1: {ctor: '[]'}
									}
								}),
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('智能聊天机器人'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('技术栈：Elixir, NLP, Elm'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
...
var _user$project$Views_Home$contactDetail = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _user$project$Views_Home$class(
		...
		_0: A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('pure-form pure-form-stacked'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Your Name'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
												...
												_1: {
													...
													_0: A2(
														_elm_lang$html$Html$input,
														{
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$placeholder('Your Password'),
																_1: {ctor: '[]'}
															}
														},
														{ctor: '[]'}),
						...
						_1: {
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Meilab： 提供最前沿的物联网行业解决方案，培训，咨询服务'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
...
var _user$project$Views_Home$footer = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _user$project$Views_Home$class(
			{
				ctor: '::',
				_0: _user$project$Styles_MarketingStyle$Footer,
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	},
...
var _user$project$Views_Home$contentHead = function (str) {
	return A2(
		_elm_lang$html$Html$h2,
		{
			ctor: '::',
...
var _user$project$Views_Home$contact = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _user$project$Views_Home$class(
			{
				ctor: '::',
				_0: _user$project$Styles_MarketingStyle$Content,
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: _user$project$Views_Home$contentHead('Meta Info'),
		_1: {
			ctor: '::',
			_0: _user$project$Views_Home$contactDetail,
			_1: {ctor: '[]'}
		}
	});
var _user$project$Views_Home$projects = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _user$project$Views_Home$class(
	...
	{
		ctor: '::',
		_0: _user$project$Views_Home$contentHead('项目'),
		_1: {
			ctor: '::',
			_0: _user$project$Views_Home$projectsDetail,
			_1: {ctor: '[]'}
		}
	});
var _user$project$Views_Home$content = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _user$project$Views_Home$class(
				{
					ctor: '::',
					_0: _user$project$Styles_MarketingStyle$ContentContainer,
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _user$project$Views_Home$projects,
			_1: {
				ctor: '::',
				_0: _user$project$Views_Home$services,
				_1: {
					ctor: '::',
					_0: _user$project$Views_Home$contact,
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$Views_Home$homeView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _user$project$Views_Home$class(
				{
					ctor: '::',
					_0: _user$project$Styles_MarketingStyle$Layout,
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A3(_user$project$ViewHelpers$marketingFixedHeader, model, 'Meilab', _user$project$Routing$routingItemHomePage),
			_1: {
				ctor: '::',
				_0: _user$project$Views_Home$splash,
				_1: {
					ctor: '::',
					_0: _user$project$Views_Home$content(model),
					_1: {
						ctor: '::',
						_0: _user$project$Views_Home$footer,
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Views_Login$loginView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('pure-form pure-form-aligned'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Messages$AuthRequest),
							_1: {ctor: '[]'}
						}
					},
					{
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('pure-control-group'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										...
										_1: {
												...
												_elm_lang$html$Html$input,
												{
													...
													_1: {
														...
														_1: {
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onInput(_user$project$Messages$Username),
																_1: {ctor: '[]'}
															}
														}
													}
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('pure-form-message-inline'),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('This is a required field'),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
										...
										_0: A2(
											...
											},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('pure-button pure-primary-button'),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$type_('submit'),
															_1: {ctor: '[]'}
				...
				},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(postMetaInfo.title),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
								...
								},
								{
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(postMetaInfo.author),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
...
var _user$project$Views_PostList$posts = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$Views_PostList$posts(model),
					_1: {
						ctor: '::',
						_0: _user$project$Views_PostList$footer,
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _user$project$Views_PostDetail$postdetailView = F2(
	function (model, slug) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				ctor: '::',
				_0: _user$project$Views_Map$mapView(model),
				_1: {ctor: '[]'}
			});
	});
...
var _user$project$Views$introView = function (model) {
	return A2(
		_evancz$elm_markdown$Markdown$toHtml,
		{ctor: '[]'},
		_user$project$Views$markdown);
};
var _user$project$Views$_p0 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('meilab');
var _user$project$Views$id = _user$project$Views$_p0.id;
var _user$project$Views$class = _user$project$Views$_p0.$class;
var _user$project$Views$classList = _user$project$Views$_p0.classList;
var _user$project$Views$menu = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _user$project$Views$class(
				{
					ctor: '::',
					_0: _user$project$Styles_LayoutStyle$SideBarMenu,
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: A3(_user$project$ViewHelpers$menuHeadingLinkItem, '', '/', 'HNA'),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$ul,
...
var _user$project$Views$view = function (model) {
	var _p1 = function () {
		var _p2 = model.ui.sideMenuActive;
		if (_p2 === true) {
			return {ctor: '_Tuple2', _0: _user$project$Styles_LayoutStyle$MenuActive, _1: _user$project$Messages$ToggleSideMenu};
		} else {
			return {ctor: '_Tuple2', _0: _user$project$Styles_LayoutStyle$MenuInActive, _1: _user$project$Messages$NoOp};
		}
	}();
	var layoutClass = _p1._0;
	var contentOnClickCmd = _p1._1;
	var contentView = function () {
		...
		switch (_p3.ctor) {
			...
			case 'RegisterRoute':
				return _user$project$Views_Login$loginView(model);
			case 'PostListRoute':
				return _user$project$Views_PostList$postlistView(model);
			case 'PostDetailRoute':
				return A2(_user$project$Views_PostDetail$postdetailView, model, _p3._0);
			case 'ProjectListRoute':
				return _user$project$Views_PostList$postlistView(model);
			case 'ProjectDetailRoute':
				return A2(_user$project$Views_PostDetail$postdetailView, model, _p3._0);
			case 'TrainingListRoute':
				return _user$project$Views_PostList$postlistView(model);
			default:
				return _user$project$Views$notFoundView;
		}
	}();
	var _p4 = model.route;
	switch (_p4.ctor) {
		...
		case 'PostListRoute':
			return _user$project$Views_PostList$postlistView(model);
		case 'PostDetailRoute':
			return A2(_user$project$Views_PostDetail$postdetailView, model, _p4._0);
		case 'LoginRoute':
			return _user$project$Views_Login$loginView(model);
		default:
			return A2(
				_elm_lang$html$Html$div,
				{
					...
					_0: _user$project$Views$class(
						{
							ctor: '::',
							_0: _user$project$Styles_LayoutStyle$Layout,
							_1: {
								ctor: '::',
								_0: layoutClass,
								_1: {ctor: '[]'}
				...
				{
					ctor: '::',
					_0: _user$project$Views$menu(model),
					_1: {
						ctor: '::',
						_0: A3(_user$project$ViewHelpers$layoutHeader, model, 'HNA', _user$project$Routing$routingItemNormalHeader),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$div,
...
var _user$project$Update$changeUrlCommandAfterLogin = F2(
	function (model, route) {
		var _p0 = route;
		if (_p0.ctor === 'LogoutRoute') {
			return _elm_lang$navigation$Navigation$newUrl(
				A2(_elm_lang$core$Basics_ops['++'], model.url.src_url, '/'));
		} else {
		...
		if (_p1.ctor === 'Nothing') {
			...
			switch (_p2.ctor) {
				...
				case 'HomeRoute':
					return _elm_lang$core$Platform_Cmd$none;
				case 'PostListRoute':
					return A2(_user$project$Commands$getPostList, model.user.token, model.url.api_url);
				case 'PostDetailRoute':
					return _elm_lang$core$Platform_Cmd$none;
				case 'ProjectListRoute':
					return _elm_lang$core$Platform_Cmd$none;
				...
				default:
					return _elm_lang$navigation$Navigation$newUrl(
						A2(_elm_lang$core$Basics_ops['++'], model.url.src_url, '/login'));
			}
		} else {
			return A2(_user$project$Update$changeUrlCommandAfterLogin, model, route);
		}
	});
	...
	function (msg, model) {
		...
		switch (_p3.ctor) {
			case 'SelectMenuTab':
				...
				var url = A2(
					...
					A2(
						...
						_p4,
						_user$project$Routing$tabsUrls(model.url.src_url)));
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							ui: A2(_user$project$Models$Ui, _p4, model.ui.sideMenuActive)
						}),
			...
			case 'OnLocationChange':
				var _p6 = _p3._0;
				var newSelectedMenuTab = A2(
					_elm_lang$core$Maybe$withDefault,
					-1,
					A2(
						_elm_lang$core$Dict$get,
						_p6.pathname,
						_user$project$Routing$urlTabs(model.url.src_url)));
				var newRoute = A2(_user$project$Routing$parseLocation, _p6, model.url.src_url);
				var newUser = function () {
					var _p5 = newRoute;
					if (_p5.ctor === 'LogoutRoute') {
						return _user$project$Models$initialUser;
					} else {
						return model.user;
					}
				}();
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							route: newRoute,
							ui: A2(_user$project$Models$Ui, newSelectedMenuTab, model.ui.sideMenuActive),
							user: newUser
						}),
					_1: A2(_user$project$Update$changeUrlCommand, model, newRoute)
				};
			case 'Username':
				var newUser = {username: _p3._0, password: model.user.password, token: model.user.token};
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'Password':
				var newUser = {username: model.user.username, password: _p3._0, token: model.user.token};
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'AuthRequest':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A4(_user$project$Commands$authRequest, model.user.token, model.url.api_url, model.user.username, model.user.password)
				};
			case 'OnAuthCmdResponse':
				if (_p3._0.ctor === 'Ok') {
					var _p9 = _p3._0._0;
					var token = function () {
						var _p7 = _p9.code;
						if (_p7 === '200') {
							return _elm_lang$core$Maybe$Just(_p9.token);
						} else {
							return _elm_lang$core$Maybe$Nothing;
						}
					}();
					var newUser = {username: model.user.username, password: model.user.password, token: token};
					var newCmd = function () {
						var _p8 = token;
						if (_p8.ctor === 'Just') {
							return _elm_lang$navigation$Navigation$newUrl(
								A2(_elm_lang$core$Basics_ops['++'], model.url.src_url, '/postlist'));
						} else {
							return _elm_lang$core$Platform_Cmd$none;
						}
					}();
			...
			case 'StartChat':
				return {
					...
					_0: model,
					_1: _elm_lang$navigation$Navigation$newUrl(
						A2(_elm_lang$core$Basics_ops['++'], model.url.src_url, '/botdetail'))
				};
			case 'MessageInput':
				return {
					ctor: '_Tuple2',
			...
			case 'SetLatLong':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{latitude: _p3._0, longitude: _p3._1}),
					{ctor: '[]'});
			case 'ToggleSideMenu':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							ui: A2(_user$project$Models$Ui, model.ui.selectedMenuTab, !model.ui.sideMenuActive)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
...
var _user$project$Main$init = function (location) {
	...
	var currentRoute = A2(_user$project$Routing$parseLocation, location, src_url);
	var selectedMenuTab = A2(
		_elm_lang$core$Maybe$withDefault,
		-1,
		A2(
			_elm_lang$core$Dict$get,
			location.pathname,
			_user$project$Routing$urlTabs(src_url)));
	var url = {
		origin: location.origin,
		src_url: src_url,
		api_url: A2(_elm_lang$core$Basics_ops['++'], location.origin, '/api/v1/meilab')
	};
	var initCommand = A2(
		_user$project$Update$changeUrlCommand,
		A3(_user$project$Models$initialModel, currentRoute, url, selectedMenuTab),
		currentRoute);
	return {
		ctor: '_Tuple2',
		_0: A3(_user$project$Models$initialModel, currentRoute, url, selectedMenuTab),
		_1: initCommand
	};
};
